class Classify
  ...
  constructor: (settings) ->
    ...
    @images = [
      ...
      {id: "FRE_000310.jpg", caption: "Line up of P-47 Thunderbolts of the 82nd Fighter Squadron, 78th Fighter Group, at Duxford air base. September 1944. Printed caption on reverse of print: '55432 AC - War Birds Home To Rest - Republic P-47 Thunderbolts lined up on an 8th Air Force field in England after a daylight sweep over Germany. Crews have finished inspections and refueling.'"}
      ...
      {id: "FRE_002284.jpg", caption: "The wreck of a P-51 Mustang of the 4th Fighter Group flown by Captain Don S. Gentile. Handwritten caption on reverse: 'Gentile's Mustang. R. Bowers.'"}
      ...
      {id: "FRE_008757.jpg", caption: "B-24 Liberators of the 15th Air Force in flight during a mission over Ploesti, 31 May 1944. Printed caption on image: '15th AAF Liberators bomb Ploesti refineries, 31 May 1944 US AAF photo.'"}
  ...
  data_dump_visicount: ->
    ...
    dd =
      question: question.text()
      answer: [
        window.sliders.bicycles.get()
        window.sliders.vehicles.get()
        window.sliders.aircraft.get()
      ]
      next: 0
      caption: @caption_read
  ...
  next_click: ->
    ...
    switch task_type
      ...
      when "3" then @handle_visicount_answers()
  ...
  handle_visicount_answers: ->
    data_dump = @data_dump_visicount()
    dd = @add_to_data_pool data_dump
    @advance data_dump.next
  ...
  close_caption: ->
    if $("#classify-caption-panel").is(":visible")
      $("#classify-caption-panel").slideToggle()
    @caption_read = 0
  ...
  clear_visicount: ->
    $("#visicount-panel").html("")
    $("#visicount-sliders").html("")
  ...
  notice_view: (message) ->
    "<div class='notice alert alert-info col-md-9' role=alert>"+ message + "</div>"
